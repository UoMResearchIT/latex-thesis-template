...
\usepackage{polyglossia}																														% This is a big old kludge to get APA formatting to work.
\setdefaultlanguage[variant=british]{english}																				% Although it'll save you headache in the long-run, 
\DeclareLanguageMapping{english}{english-apa}																				% it does seem a bit of a pain to add all this overhead
\usepackage{csquotes}																																% for what should be a defined profile native to biblatex.
\usepackage[style=apa,sorting=nyt]{biblatex}																				% This implements biblatex citation system.
% \usepackage[citestyle=authoryear-icomp,sorting=nyt,bibstyle=authoryear]{biblatex}	% This is an alterative that uses simpler author-year, but not APA.
